...
void funcion_idle() {
   if (escena !=0 && escena->getIluminacion() == true || escena->getIluminacion_pos() == true)
      escena->animarPosicionLuz();
   if (escena !=0 && escena->getAutomatico() == true)
...
int main( int argc, char **argv )
{
   ...
   glutCreateWindow("Practicas IG: JOAQUIN SERGIO GARCIA IBAÑEZ");
